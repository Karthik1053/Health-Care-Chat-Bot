...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        self.lblQuestion=Label(self,text="Question",width=12,bg="black")
        self.lblQuestion.grid(row=0,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Digonosis",width=12,bg="black")
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        super().__init__(master=master)
        master.geometry("3000x2500")
        master.title("Account Login")
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="black", width="1000", height="5", font=("Calibri", 13))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="5", width="1000", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="5", width="1000", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="slateblue4", width = "350", height = "2", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Karthik Reddy", bg="RoyalBlue1", width = "350", height = "2", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="S.Shivani", bg="RoyalBlue2", width = "350", height = "2", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Meghana", bg="RoyalBlue3", width = "350", height = "2", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="V.Varun", bg="RoyalBlue3", width = "350", height = "2", font=("Calibri", 13))
        self.lblTeam4.pack()
